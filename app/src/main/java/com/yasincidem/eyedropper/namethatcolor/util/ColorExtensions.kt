...
import com.yasincidem.eyedropper.namethatcolor.model.Hsl
import com.yasincidem.eyedropper.namethatcolor.model.Rgb
...
fun String.toXmlName(percentAlpha: Int?): String {
    var name = this.lowercase().replace(" ", "_")
    if (percentAlpha != null) {
        name += "_alpha_$percentAlpha"
    }
    return name
}