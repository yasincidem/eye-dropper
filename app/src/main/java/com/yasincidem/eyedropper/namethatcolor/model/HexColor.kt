package com.yasincidem.eyedropper.namethatcolor.model

import com.yasincidem.eyedropper.namethatcolor.util.hsl
import com.yasincidem.eyedropper.namethatcolor.util.rgb
import com.yasincidem.eyedropper.namethatcolor.util.roundTo2Decimal
import com.yasincidem.eyedropper.namethatcolor.util.roundTo2HexString
    ...
    init {
        ...
        if (cup.contains("%")) {
            ...
            if (alphaValueText.isNotEmpty()) {
                ...
                alpha = (alphaValue / 100.0 * 255).roundTo2HexString().uppercase()
